...
Copy-Item "target\release\evox2-control.exe" (Join-Path $dist "evox2-control.exe") -Force
Copy-Item "target\release\evox2-control.exe" (Join-Path $dist "evox2ctl.exe") -Force
